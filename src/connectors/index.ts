...
import { create as createGoogleCalendar, validate as validateGoogleCalendar } from "./google-calendar.js";
import { create as createGmail, validate as validateGmail } from "./gmail.js";
...
const registry = new Map<string, ConnectorEntry>([
  ...
  ["google_calendar", { factory: createGoogleCalendar, validate: validateGoogleCalendar }],
  ["gmail", { factory: createGmail, validate: validateGmail }],
